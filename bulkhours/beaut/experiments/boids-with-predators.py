...
for i in range(NUM_PREY):
    prey = Boid(random.randint(BORDER, SCREEN_WIDTH - BORDER), random.randint(BORDER, SCREEN_HEIGHT - BORDER),
                100, 40, 5, 15, 0, FIELD_OF_VIEW, MAX_PREY_SPEED, "bulkhours/beaut/experiments/resources/img/boid.png")
...
for i in range(NUM_PREDATORS):
    predator = Boid(random.randint(BORDER, SCREEN_WIDTH - BORDER), random.randint(BORDER, SCREEN_HEIGHT - BORDER),
                    100, 40, 5, 0, 50, FIELD_OF_VIEW, MAX_PREDATOR_SPEED, "bulkhours/beaut/experiments/resources/img/predator.png")
