...
def get_fr_unemployement(**kwargs):
    data = StringIO(
...
def get_us_gdp(simplify=True, **kwargs):
...
def get_fr_gdp(simplify=True, **kwargs):
    gdp = get_fr_qgdp().reset_index()
    une = get_fr_unemployement().reset_index()
